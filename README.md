This project design the tables to hold the data from the CSV files, The CSV files needed to import into a SQL database are listed in the EmployeeSQL/Starter_Code/data path 
